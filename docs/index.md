...
<section class="hero">
  ...
  <h1><span class="hero-title-line">建好库，接上 Agent，</span><span class="hero-title-line">剩下的让 Agent 代劳。</span></h1>
...
<div class="callout agent">
  <strong>Agent 是 PaperPiggy 的核心使用方式。</strong>完成首次建库后，就可以先接上 Agent；深索和检索摘要不必全部由你手工处理。
</div>
...
<div class="page-next">
  <span></span>
  <a href="{{ '/quick-start/' | relative_url }}">下一章：10 分钟快速开始 →</a>
</div>
